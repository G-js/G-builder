...
BuilderStream.prototype.copy = function () {
    return this.pipe(require('../builders/fs').copy);
};

BuilderStream.prototype.uglify = function () {
    return this.pipe(require('../builders/uglify'));
};

BuilderStream.prototype.jshint = function () {
    return this.pipe(require('../builders/jshint'));
};

BuilderStream.prototype.concat = function () {
